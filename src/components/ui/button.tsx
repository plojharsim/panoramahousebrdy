  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium font-body transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Custom variants for Panorama House
        hero: "bg-primary-foreground text-primary hover:bg-accent hover:text-accent-foreground shadow-lg text-base font-semibold tracking-wide",
        heroOutline: "border-2 border-primary-foreground bg-transparent text-primary-foreground hover:bg-primary-foreground/10 text-base font-medium",
        accent: "bg-accent text-accent-foreground hover:bg-accent/80 shadow-md font-semibold",
        nature: "bg-primary text-primary-foreground hover:bg-primary/80 shadow-sm",
      },
      size: {
